...
const styles = StyleSheet.create({
  ...
  container: {
    flex: 1,
    backgroundColor: "#ffffff", // nền content
  },
  ...
  specialCard: {
    ...
    borderWidth: 1,
    borderColor: "rgba(255,255,255,0.25)", // 👈 viền mờ đẹp
  },
  ...
  placeImage: {
    width: "100%",
    height: 120,
    resizeMode: "cover", // 👈 ảnh tràn viền đẹp
  },
  ...
  priceCard: {
    ...
    backgroundColor: "#FFF",
    borderRadius: 16,
    overflow: "hidden", // 🔥 bắt buộc để ảnh tràn viền đẹp
