...
const SkeletonCard = () => {
  ...
  return (
    <Animated.View style={[styles.orderCard, { opacity: anim }]}>
      <View
        style={{
          height: 14,
          width: "50%",
...
export default function OrderScreen() {
  ...
  const renderItem = ({ item }: { item: Order }) => {
    ...
    return (
      <Pressable style={styles.orderCard} onPress={() => {}}>
        {/* Header */}
        ...
        {firstItem && (
          <View style={styles.productRow}>
            <View style={styles.productIconBox}>
              <FontAwesome name="motorcycle" size={22} color="#999" />
            </View>
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.header}>
        ...
        <Pressable style={styles.backBtn} onPress={fetchOrders} hitSlop={12}>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyBox}>
              <Ionicons name="receipt-outline" size={72} color="#DDD" />
...
const styles = StyleSheet.create({
  ...
  orderId: { fontSize: 14, fontWeight: "800", color: "#111", marginBottom: 3 },
  ...
  moreItems: { fontSize: 12, color: "#AAA", marginTop: 2 },
  productQty: { fontSize: 14, fontWeight: "600", color: "#888" },
  ...
  totalGroup: { flexDirection: "row", alignItems: "center" },
  totalLabel: { fontSize: 13, color: "#888" },
  totalValue: { fontSize: 15, fontWeight: "800", color: "#FF4D4D" },
